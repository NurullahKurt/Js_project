...
let elemanSilmeButonu=document.querySelector(".fa-times");
const temizleButonu=documentç.querySelector("hepsinisil");


//Butonlaa dinleyici tanımlanması
...
function elemanEkle(){
    ...
    //input kısmı null değilse aşağıdaki ilemler yağılır
    else{

        //li elementini seçerek li değişkenini ata
        var li=document.createElement("li");

        //li değiskeninin açıklamasını inputa yazışan yazıya eşitle
...
function elemanlariSil(){
    var secim=confirm("Hepsini Kalıcı Olarak Silmek İstediğinğzden Emin misiniz?");
    if(secim==true){
